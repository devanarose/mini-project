                         ...
                         <div class="banner-info">
                             <div class="container">
                                 <div class="banner-info-bg">
                                     ...
                                     <!-- <a class="btn btn-style transparent-btn mt-sm-5 mt-4" href="homedemo.php"> Book Now</a> -->
                                 </div>
                             </div>
                         </div>
                     </div>
                 ...
                 <li>
                     <div class="slider-info  banner-view banner-top1 bg bg2">
                         <div class="banner-info">
                             <div class="container">
                                 <div class="banner-info-bg">
                                     <h5>Our hotel will play a leading role in prompting the world peace.</h5>
                                     <a class="btn btn-style transparent-btn mt-sm-5 mt-4" href="booking.php">Book Now</a>
                                 </div>
                             </div>
                         </div>
                     </div>
                         ...
                         <div class="banner-info">
                             <div class="container">
                                 <div class="banner-info-bg">
                                     ...
                                     <!-- <a class="btn btn-style transparent-btn mt-sm-5 mt-4" href="demo.php">Book Now</a> -->
                                 </div>
                             </div>
                         </div>
                     </div>
    ...
    <div class="container py-sm-4">
        <div class="row">
            <div class="col-lg-6 about-left mb-md-0 mb-5">
                ...
                <p class="mt-3">Spread over six acres of lush gardens, offering an outdoor swimming pool and panoramic city views, Hotel Nikko Saigon is located in Panampilly. WiFi access is available. Each room here will provide you with air conditioning and a mini-bar. There is also an electric kettle. Featuring a shower, private bathroom also comes with a bath and a hairdryer. You will find a fitness center. Other facilities offered at the property include meeting facilities. An array of activities can be enjoyed on site or in the surroundings, The property offers free parking. The property has four award-winning restaurants featuring an array of cuisines from across the world, a stylish bar, nine-hole putting greens, a temperature-controlled swimming pool and an expansive Jiva Spa make Hotel nikko saigon, a true urban oasis. The property has a highly specialized electronic air filtration system that helps maintain the air quality in the hotel. Guests can enjoy butler service, exclusive access to the Club Lounge and other special privileges when staying at Rooms and Suites. </p>
            ...
            <div class="col-lg-6 about-right position-relative mt-lg-0 mt-5">
                <img src="assets/images/bottom.jpg" alt="" class="img-fluid img-border mt-4" />
                <img src="assets/images/top.jpg" alt="" class="img-fluid position-absolute img-position" />
            </div>
        </div>
    </div>
</section>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 mt-lg-0 mt-5 about-right-faq align-self">
                    ...
                    <ul class="w3l-right-book mt-4">
                        ...
                        <li><span class="fa fa-check" aria-hidden="true"></span>Single, double and suite rooms</li>
...
<div class="quotation py-5">
    <div class="container py-xl-5 py-lg-3">
        <div class="welcome-left text-center py-md-5 py-3">
         ...
         <!--    <a href="homedemo.php" class="btn btn-style transparent-btn mt-sm-5 mt-4 mr-2">Book Now</a> -->
